...
console.table(items); // Початковий список

storage.addItem('Дроїд');
console.table(storage.items); // Список після додавання 'Дроїд'

storage.removeItem('Пролонгер');
console.table(storage.items); // Список після видалення 'Пролонгер'
// 5
// class Car {
//   static getSpecs(car) {
//     console.log(
